...
@showprogress for iter in 1:nt
    ...
    @inbounds Threads.@threads for i = 1:KS.pSpace.nx+1
        flux_tst!(
            ...
            face[i].fh2,
            face[i].fh3,
            ctr[i-1].w .+ 0.5 .* ctr[i-1].sw .* ctr[i-1].dx,
            ctr[i-1].h0 .+ 0.5 .* ctr[i-1].sh0 .* ctr[i-1].dx,
            ctr[i-1].h1 .+ 0.5 .* ctr[i-1].sh1 .* ctr[i-1].dx,
            ctr[i-1].h2 .+ 0.5 .* ctr[i-1].sh2 .* ctr[i-1].dx,
            ctr[i-1].h3 .+ 0.5 .* ctr[i-1].sh3 .* ctr[i-1].dx,
            ctr[i].w .- 0.5 .* ctr[i].sw .* ctr[i].dx,
            ctr[i].h0 .- 0.5 .* ctr[i].sh0 .* ctr[i].dx,
            ctr[i].h1 .- 0.5 .* ctr[i].sh1 .* ctr[i].dx,
            ctr[i].h2 .- 0.5 .* ctr[i].sh2 .* ctr[i].dx,
            ctr[i].h3 .- 0.5 .* ctr[i].sh3 .* ctr[i].dx,
            KS.vSpace.u,
            KS.vSpace.weights,
            KS.gas.K,
            KS.gas.γ,
