...
Kinetic.jl concerns theoretical and numerical studies of many-particle systems of gases, photons, plasmas, neutrons, etc.
It employs the finite volume method (FVM) to conduct 1-3 dimensional numerical simulations on CPUs and GPUs.
Besides of general advection-diffusion-type equations, 
special attentions have been paid on Hilbert's sixth problem, i.e. to build the passage between continuum mechanics and kinetic theory of gases.
Different type of equations can be solved, e.g. the Boltzmann equation 
...
the neural kinetic equations with the general formulation as
...
and the upscaling moment systems, e.g. the Euler and Navier-Stokes
