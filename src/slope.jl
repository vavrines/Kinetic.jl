...
function reconstruct2(wL::AbstractArray{Float64,2}, wR::AbstractArray{Float64,2}, Δx::Float64)
    s = zeros(axes(wL))
    for j in axes(s, 2)
...
function reconstruct3( wL::AbstractArray{Float64,2}, wN::AbstractArray{Float64,2}, wR::AbstractArray{Float64,2}, 
                       ΔxL::Float64, ΔxR::Float64, limiter="vanleer"::AbstractString )
