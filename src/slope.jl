...
function weno5(wL2::Real, wL1::Real, wN::Real, wR1::Real, wR2::Real)
    ...
    β0 = 13. / 12. * (wN-2.*wR1+wR2)^2+1./4.*(3.*wN-4.*wR1+wR2)^2
    β1 = 13. / 12. *(wL1-2.*wN+wR1)^2+1./4.*(wL1-wR1)^2
    β2 = 13. / 12. *(wL2-2.*wL1+wN)^2+1./4.*(wL2-4.*wL1+3.*wN)^2
    ...
    qr0 = 1./3.*wN+5./6.*wR1-1./6.*wR2
    qr1 = -1./6.*wL1+5./6.*wN+1./3.*wR1
    qr2 = 1./3.*wL2-7./6.*wL1+11./6.*wN
    ...
    ql0 = 11./6.*wN-7./6.*wR1+1./3.*wR2
    ql1 = 1./3.*wL1+5./6.*wN-1./6.*wR1
    ql2 = -1./6.*wL2+5./6.*wL1+1./3.*wN
